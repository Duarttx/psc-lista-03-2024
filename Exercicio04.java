...
public class Exercicio04 {
    public static void main(String[] args) {
        ...
        System.out.print("Digite o valor do raio em centímetros: ");
        raio = input.nextDouble();

        System.out.print(
                "Digite 1 para calcular o perímetro, 2 para calcular a área do circulo, 3 para calcular o volume da esfera");
        op = input.nextInt();
